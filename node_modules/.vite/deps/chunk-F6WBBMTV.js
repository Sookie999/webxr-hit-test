...
var ThinBlurPostProcess = class _ThinBlurPostProcess extends EffectWrapper {
  _gatherImports(useWebGPU, list) {
    if (useWebGPU) {
      ...
      list.push(Promise.all([import("./kernelBlur.fragment-U4C3DPUE.js"), import("./kernelBlur.vertex-XFIJL4FA.js")]));
    } else {
      list.push(Promise.all([import("./kernelBlur.fragment-3I3KARPF.js"), import("./kernelBlur.vertex-D6DLQ5YD.js")]));
    }
  }
  /**
...
var ShadowGenerator = class _ShadowGenerator {
  ...
  async _initShaderSourceAsync(forceGLSL = false) {
    ...
    if (engine.isWebGPU && !forceGLSL && !_ShadowGenerator.ForceGLSL) {
      ...
      await Promise.all([
        import("./shadowMap.fragment-A7EA2XNI.js"),
        import("./shadowMap.vertex-S2WZCUMX.js"),
        import("./depthBoxBlur.fragment-TNAPWGHZ.js"),
        import("./shadowMapFragmentSoftTransparentShadow-3D26DUNM.js")
      ]);
    } else {
      await Promise.all([
        import("./shadowMap.fragment-JD3EOHB7.js"),
        import("./shadowMap.vertex-TPS6XFXJ.js"),
        import("./depthBoxBlur.fragment-WM4L7PBO.js"),
        import("./shadowMapFragmentSoftTransparentShadow-GSFJXCE5.js")
      ]);
    }
...
var DepthRenderer = class _DepthRenderer {
  ...
  constructor(scene, type = 1, camera = null, storeNonLinearDepth = false, samplingMode = Texture.TRILINEAR_SAMPLINGMODE, storeCameraSpaceZ = false, name) {
    ...
    this._depthMap = new RenderTargetTexture(name ?? "DepthRenderer", { width: engine.getRenderWidth(), height: engine.getRenderHeight() }, this._scene, false, true, type, false, samplingMode, void 0, void 0, void 0, format);
  ...
  async _initShaderSourceAsync(forceGLSL = false) {
    ...
    if (engine.isWebGPU && !forceGLSL && !_DepthRenderer.ForceGLSL) {
      this._shaderLanguage = 1;
      await Promise.all([import("./depth.vertex-DIRA6SSX.js"), import("./depth.fragment-OI5AQMSN.js")]);
    } else {
      await Promise.all([import("./depth.vertex-7CYR3XEL.js"), import("./depth.fragment-77JP63OR.js")]);
    }
    this._shadersLoaded = true;
  }
  /**
...
//# sourceMappingURL=chunk-F6WBBMTV.js.map
