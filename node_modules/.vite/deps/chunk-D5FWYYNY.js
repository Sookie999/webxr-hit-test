...
var RGBDTextureTools = class {
  ...
  static ExpandRGBDTexture(texture) {
    ...
    const expandRgbdTextureAsync = async () => {
      ...
      internalTexture.isReady = false;
      if (isWebGpu) {
        await import("./rgbdDecode.fragment-K42VE3MX.js");
      } else {
        await import("./rgbdDecode.fragment-7CIG6C2D.js");
      }
  ...
  static async EncodeTextureToRGBD(internalTexture, scene, outputTextureType = 0) {
    if (!scene.getEngine().isWebGPU) {
      await import("./rgbdEncode.fragment-3JSWV3TF.js");
    } else {
      await import("./rgbdEncode.fragment-JTSL3MSA.js");
    }
...
//# sourceMappingURL=chunk-D5FWYYNY.js.map
