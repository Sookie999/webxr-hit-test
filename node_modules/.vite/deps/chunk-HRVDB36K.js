...
var name11 = "bumpFragment";
var shader11 = `var uvOffset: vec2f= vec2f(0.0,0.0);
...
var name12 = "depthPrePass";
var shader12 = `#ifdef DEPTHPREPASS
...
var name13 = "lightFragment";
var shader13 = `#ifdef LIGHT{X}
...
var name15 = "oitFragment";
var shader15 = `#ifdef ORDER_INDEPENDENT_TRANSPARENCY
...
var shader16 = `fn LTCUv(N: vec3f,V: vec3f,roughness: f32)->vec2f {var LUTSIZE: f32=64.0;var LUTSCALE: f32=( LUTSIZE-1.0 )/LUTSIZE;var LUTBIAS:f32=0.5/LUTSIZE;var dotNV:f32=saturate( dot( N,V ) );var uv:vec2f=vec2f( roughness,sqrt( 1.0-dotNV ) );uv=uv*LUTSCALE+LUTBIAS;return uv;}
...
var name17 = "clusteredLightingFunctions";
var shader17 = `struct ClusteredLight {vLightData: vec4f,
vLightDiffuse: vec4f,
vLightSpecular: vec4f,
vLightDirection: vec4f,
vLightFalloff: vec4f,}
...
//# sourceMappingURL=chunk-HRVDB36K.js.map
