...
var ThinPassPostProcess = class _ThinPassPostProcess extends EffectWrapper {
  _gatherImports(useWebGPU, list) {
    if (useWebGPU) {
      ...
      list.push(Promise.all([import("./pass.fragment-LYEA2WA3.js")]));
    } else {
      list.push(Promise.all([import("./pass.fragment-XFUHDVH5.js")]));
    }
...
var ThinPassCubePostProcess = class _ThinPassCubePostProcess extends EffectWrapper {
  _gatherImports(useWebGPU, list) {
    if (useWebGPU) {
      this._webGPUReady = true;
      list.push(Promise.all([import("./passCube.fragment-35Z5WWYF.js")]));
    } else {
      list.push(Promise.all([import("./passCube.fragment-RSNX5IMS.js")]));
    }
    super._gatherImports(useWebGPU, list);
  }
  /**
...
//# sourceMappingURL=chunk-WXCFXYXD.js.map
