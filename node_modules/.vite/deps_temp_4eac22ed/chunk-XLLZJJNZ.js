...
var _WebAudioEngine = class extends AudioEngineV2 {
  ...
  async createBusAsync(name, options = {}) {
    const module = await import("./webAudioBus-3GZHNSGH.js");
  ...
  async createSoundAsync(name, source, options = {}) {
    const module = await import("./webAudioStaticSound-3VX2PKGQ.js");
  ...
  async createSoundSourceAsync(name, source, options = {}) {
    const module = await import("./webAudioSoundSource-BECB4MAA.js");
  ...
  async createStreamingSoundAsync(name, source, options = {}) {
    const module = await import("./webAudioStreamingSound-YDXC2WBF.js");
...
//# sourceMappingURL=chunk-XLLZJJNZ.js.map
