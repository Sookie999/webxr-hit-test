...
} from "./chunk-O7B3SYLT.js";
import {
  EasingFunction,
  QuadraticEase,
  SineEase
} from "./chunk-LIKU3S23.js";
import {
  CameraInputTypes,
  Material,
  Mesh,
...
} from "./chunk-ET26GHHM.js";
import "./chunk-UKGB4G3Q.js";
import {
  Curve3
} from "./chunk-7ZXDP25H.js";
import {
  Axis
} from "./chunk-FF6PSLVD.js";
    ...
    if (this._cachedDefines !== defines) {
      ...
      this._drawWrapper.effect = engine.createEffect(shaders, [VertexBuffer.PositionKind], this._uniforms, this._samplers, defines, void 0, void 0, () => {
        ...
        if (this._options.extraInitializationsAsync) {
          if (this.shaderLanguage === 1) {
            await Promise.all([import("./procedural.vertex-BNYXWRD4.js"), this._options.extraInitializationsAsync()]);
          } else {
            await Promise.all([import("./procedural.vertex-4CBOPXOI.js"), this._options.extraInitializationsAsync()]);
          }
        } else {
          if (this.shaderLanguage === 1) {
            await import("./procedural.vertex-BNYXWRD4.js");
          } else {
            await import("./procedural.vertex-4CBOPXOI.js");
          }
        }
      });
    }
    ...
    if (material) {
      ...
      options.extraInitializationsAsync = async () => {
        if (this._shaderLanguage === 1) {
          await Promise.all([import("./color.vertex-DGJ4JLQZ.js"), import("./color.fragment-OELHP6LO.js")]);
        } else {
          await Promise.all([import("./color.vertex-SXWPWLAD.js"), import("./color.fragment-OE63FJWQ.js")]);
        }
      };
