import "./chunk-LAGS7MUL.js";
import "./chunk-4LJ2PI4W.js";
import "./chunk-IKEWDG34.js";
import "./chunk-OW7YCHXZ.js";
import "./chunk-3PJU5P3W.js";
import "./chunk-OXOTDMQC.js";
...
var name23 = "pbrBlockReflectance0";
var shader23 = `float reflectanceF0=reflectivityOut.reflectanceF0;vec3 specularEnvironmentR0=reflectivityOut.colorReflectanceF0;vec3 specularEnvironmentR90=reflectivityOut.colorReflectanceF90;
#ifdef ALPHAFRESNEL
...
var name24 = "pbrClusteredLightingFunctions";
var shader24 = `#if defined(CLUSTLIGHT_BATCH) && CLUSTLIGHT_BATCH>0
...
var name25 = "pbrBlockNormalGeometric";
var shader25 = `vec3 viewDirectionW=normalize(vEyePosition.xyz-vPositionW);
#ifdef NORMAL
...
var name26 = "pbrBlockNormalFinal";
var shader26 = `#if defined(FORCENORMALFORWARD) && defined(NORMAL)
...
var name27 = "pbrBlockLightmapInit";
var shader27 = `#ifdef LIGHTMAP
...
var name28 = "pbrBlockGeometryInfo";
var shader28 = `float NdotVUnclamped=dot(normalW,viewDirectionW);float NdotV=absEps(NdotVUnclamped);float alphaG=convertRoughnessToAverageSlope(roughness);vec2 AARoughnessFactors=getAARoughnessFactors(normalW.xyz);
#ifdef SPECULARAA
...
var shader32 = `vec3 finalDiffuse=diffuseBase;finalDiffuse*=surfaceAlbedo;
...
var shader35 = `#if SCENE_MRT_COUNT>0
...
var shader37 = `#define PBR_FRAGMENT_SHADER
...
//# sourceMappingURL=pbr.fragment-QEUAHIGE.js.map
