...
var ThinBlurPostProcess = class _ThinBlurPostProcess extends EffectWrapper {
  _gatherImports(useWebGPU, list) {
    if (useWebGPU) {
      ...
      list.push(Promise.all([import("./kernelBlur.fragment-BFZCUXYV.js"), import("./kernelBlur.vertex-JQKWO27Y.js")]));
    } else {
  ...
  async _initShaderSourceAsync(forceGLSL = false) {
    ...
    if (engine.isWebGPU && !forceGLSL && !_ShadowGenerator.ForceGLSL) {
      ...
      await Promise.all([
        ...
        import("./shadowMap.vertex-GMKWA4ZU.js"),
      ...
      await Promise.all([
        ...
        import("./shadowMap.vertex-RHMV6MVB.js"),
...
var DepthRenderer = class _DepthRenderer {
  ...
  async _initShaderSourceAsync(forceGLSL = false) {
    ...
    if (engine.isWebGPU && !forceGLSL && !_DepthRenderer.ForceGLSL) {
      this._shaderLanguage = 1;
      await Promise.all([import("./depth.vertex-V6KSLG3M.js"), import("./depth.fragment-TCGU57NT.js")]);
    } else {
      await Promise.all([import("./depth.vertex-3YDXY33F.js"), import("./depth.fragment-GKVADYM4.js")]);
    }
    this._shadersLoaded = true;
  }
  /**
...
//# sourceMappingURL=chunk-ZZAFB4NW.js.map
